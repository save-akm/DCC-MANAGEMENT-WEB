...
import EditDelivery from "@/components/form/EditDelivery"
import DeleteAlert from "@/components/Card/DeleteAlert"

 
export const columnsDelivery: ColumnDef<PickingDelivery>[] = [
  {
    accessorKey: "pklno",
    header: ({ column }) => {
      return (
  ...
  //                 variant="outline"
  //                 onClick={() =>
  //                   navigator.clipboard.writeText(delivery.pklno.toString())
  //                 }
  //               >
  //                 Copy Monitor Name
  //               </Button>
  //             </DropdownMenuItem>
  //             <DropdownMenuItem asChild>
  //               <EditDelivery ref={refForm} data={delivery} />
  //             </DropdownMenuItem>
  //             <DropdownMenuItem asChild>
