...
import { PickingDelivery } from "@/lib/types/type";
...
interface Props {
  data: PickingDelivery;
}

const EditPicking = forwardRef<HTMLFormElement, Props>((props, ref) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-4xl">
        <DialogHeader>
          <DialogTitle>Edit Picking</DialogTitle>
          <DialogDescription>
            Make changes to your Picking here. Click Submit when youre
            done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
